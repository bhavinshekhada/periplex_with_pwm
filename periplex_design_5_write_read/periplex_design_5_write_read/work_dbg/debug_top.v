...
module edb_top (
    ...
    input  la0_probe2,
    input  la0_probe3,
    input  [6:0] la0_probe4,
    input  la0_probe5,
    input  la0_probe6,
    input  la0_probe7,
    input  [6:0] la0_probe8,
    input  [6:0] la0_probe9,
    input  la0_probe10,
    input  la0_probe11,
    input  la0_probe12,
    input  la0_probe13,
    input  [50:0] la0_probe14,
    input  [31:0] la0_probe15,
    input  la0_probe16,
    input  [1:0] la0_probe17,
    input  la0_probe18,
    input  [63:0] la0_probe19,
    input  [3:0] la0_probe20,
    input  la1_clk,
    input  la1_probe0,
    input  la1_probe1,
    input  la2_clk,
    input  [7:0] la2_probe0,
    input  la2_probe1,
    input  la3_clk,
    input  [7:0] la3_probe0
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'hbda26abb60bb4df6ba7150246306acaf ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h7dffe0f7150641d0be994342fdcdd44d ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h46f209c568d44b178cea9b113c970d90 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h4320b9705a804cf7a0b14bb865028c0f ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 )
    ) la3 (
